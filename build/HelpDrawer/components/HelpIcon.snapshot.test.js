...
function setup(title, text, buttonLabel) {
    ...
    return (0, _enzyme.shallow)(_react2.default.createElement(_HelpIcon2.default, _extends({}, props, { inline: true })));
}

describe('HelpIcon snapshots tests', function () {
    it('renders menu', function () {
        ...
        var wrapper = setup('HelpDrawer Title', hdText, 'Close');
...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(setup, 'setup', 'src/HelpDrawer/components/HelpIcon.snapshot.test.js');
}();
