...
var AuthorsPublicationsPerYearChart = function (_React$Component) {
    ...
    _createClass(AuthorsPublicationsPerYearChart, [{
        ...
        value: function render() {
            return _react2.default.createElement(_Chart2.default, { className: (this.props.className || '') + ' authors-publications-per-year-chart', chartOptions: this.state.options });
        }
    }]);
