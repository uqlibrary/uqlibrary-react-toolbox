...
function setup(props) {
    ...
    return (0, _enzyme.shallow)(_react2.default.createElement(_AutoCompleteSelect2.default, props), { context: { muiTheme: (0, _getMuiTheme2.default)() } });
}
...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(setup, 'setup', 'src/AutoCompleteSelect/components/AutoCompleteSelect.snapshot.test.js');
}();
