...
var AutoCompleteSelect = function (_Component) {
    ...
    function AutoCompleteSelect(props) {
        ...
        _this.getFilteredItems = function () {
            return _this.__getFilteredItems__REACT_HOT_LOADER__.apply(_this, arguments);
        };
    ...
    _createClass(AutoCompleteSelect, [{
        ...
        key: '__getFilteredItems__REACT_HOT_LOADER__',
        value: function __getFilteredItems__REACT_HOT_LOADER__() {
            var _this2 = this;

            return this.props.dataSource.filter(function (item) {
                var label = item[_this2.props.dataSourceConfig.text];
                return !label || !_this2.state.searchText || label.toLowerCase().includes(_this2.state.searchText.toLowerCase());
            });
        }
    }, {
        ...
        value: function render() {
            ...
            var selectedItem = this.props.dataSource.find(function (item) {
                return item[_this3.props.dataSourceConfig.value] === _this3.props.value;
            });
                    ...
                    _react2.default.createElement(
                        ...
                        filteredItems.slice(0, this.props.maxSearchResults).map(function (item, index) {
                            return _react2.default.createElement(_MenuItem2.default, {
                                key: index,
                                tabIndex: index,
                                value: item[_this3.props.dataSourceConfig.value],
                                primaryText: item[_this3.props.dataSourceConfig.text] });
                        })
                    ),
...
var _default = AutoCompleteSelect;
...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(AutoCompleteSelect, 'AutoCompleteSelect', 'src/AutoCompleteSelect/components/AutoCompleteSelect.js');

    __REACT_HOT_LOADER__.register(_default, 'default', 'src/AutoCompleteSelect/components/AutoCompleteSelect.js');
}();
