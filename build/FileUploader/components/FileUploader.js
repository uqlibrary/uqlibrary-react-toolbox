...
var FileUploader = exports.FileUploader = function (_PureComponent) {
    ...
    function FileUploader(props) {
        ...
        _this._handleDroppedFiles = function (uniqueFilesToQueue, errorsFromDropzone) {
            ...
            // Set files to queue
            _this.setState({
                filesInQueue: defaultQuickTemplateId ? totalFiles.map(function (file) {
        ...
        _this.getErrorMessage = function (errors) {
            ...
            Object.keys(errors).map(function (errorCode) {
                ...
                if (fileNames && fileNames.length > 0 && validation[errorCode]) {
                    errorMessages.push(validation[errorCode].replace('[numberOfFiles]', fileNames.length).replace('[fileNames]', fileNames.join(', ')).replace('[maxNumberOfFiles]', '' + _this.props.fileRestrictionsConfig.fileUploadLimit));
                }
            });
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_FileUploadDropzone2.default, {
                    ...
                    disabled: disabled,
                    filesInQueue: this.state.filesInQueue.map(function (file) {
                        return file.name;
                    }),
...
FileUploader.defaultProps = {
    locale: {
        ...
        validation: (_validation = {}, _defineProperty(_validation, 'notFiles', 'Invalid files ([fileNames])'), _defineProperty(_validation, 'invalidFileNames', 'File(s) ([fileNames]) have invalid file name'), _defineProperty(_validation, 'tooBigFiles', 'File(s) ([fileNames]) exceed maximum allowed upload file size'), _defineProperty(_validation, 'tooManyFiles', 'Maximum number of files ([maxNumberOfFiles]) has been exceeded. File(s) ([fileNames]) will not be uploaded'), _defineProperty(_validation, 'duplicateFiles', 'File(s) ([fileNames]) are duplicates and have been ignored'), _validation),
