...
var FileUploadRow = exports.FileUploadRow = function (_PureComponent) {
    _inherits(FileUploadRow, _PureComponent);
    ...
    function FileUploadRow() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = FileUploadRow.__proto__ || Object.getPrototypeOf(FileUploadRow)).call.apply(_ref, [this].concat(args))), _this), _this._showConfirmation = function () {
            if (_this.confirmationBox) _this.confirmationBox.showConfirmation();
